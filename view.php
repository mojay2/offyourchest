...
<html lang="en">
    ...
    <div class="container mt-5">
        ...
        <?php foreach($query as $q){?>
            <div class="title-card p-3 rounded-lg text-white text-center">
                <h1 id="blog-title"><?php echo $q['title'];?></h1>               
                <div class="d-flex mt-2 rounded-lg justify-content-center align-items-center">
                    <a href="edit.php?id=<?php echo $q['id']?>" class="btn btn-sm btn-outline-light btn2">Edit</a>
                    <a href="viewall.php?>" class="btn btn-sm btn-outline-light btn2 mx-1">Back</a>
            ...
            <div class="content-card mt-3">
                <p class="mt-1 font-weight-bold border-left border-right border-3 border-dark pl-3 view-p"><?php echo $q['content'];?></p>
            </div>
